...
contract Configurator is RecoverableFunds {
    ...
    constructor() {
        ...
        sale.addStage(1629068400, 1629673200, 500, 30000000000000000, 0, 0, 27972000000000000000000000, 0, 0, 5, 10);
        sale.addStage(1629673200, 1630278000, 300, 30000000000000000, 0, 0, 27972000000000000000000000, 0, 0, 5, 10);
        sale.addStage(1630278000, 1630882800, 200, 30000000000000000, 0, 0, 28056000000000000000000000, 0, 0, 5, 10);
